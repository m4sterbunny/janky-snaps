...
export declare type SelectorFunction<Event extends EventConstraint, EventType extends Event['type'], ReturnValue> = (...args: ExtractEventPayload<Event, EventType>) => ReturnValue;
 ...
 */
export declare type NamespacedBy<Namespace extends string, Name extends string> = Name extends `${Namespace}:${string}` ? Name : never;
export declare type NotNamespacedBy<Namespace extends string, Name extends string> = Name extends `${Namespace}:${string}` ? never : Name;
